...
- [Vue3 模板语法](/vue3/003-Vue3TemplateSyntax)：建议先完成前一篇的学习

## 学习目标

- 掌握「1. 指令概述」的核心机制、典型用法与常见陷阱
- 掌握「2. 内置指令」的核心机制、典型用法与常见陷阱
- 掌握「3. 自定义指令」的核心机制、典型用法与常见陷阱
- 掌握「4. 指令的应用场景」的核心机制、典型用法与常见陷阱
