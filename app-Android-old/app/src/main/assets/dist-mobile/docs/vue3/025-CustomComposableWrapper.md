...
- [组合式 API 优势场景](/vue3/024-CompositionAPIAdvantageScene)：建议先完成前一篇的学习

## 学习目标

- 掌握「1. Composable 设计原则」的核心机制、典型用法与常见陷阱
- 掌握「2. 常见 Composable 模式」的核心机制、典型用法与常见陷阱
- 掌握「3. 最佳实践」的核心机制、典型用法与常见陷阱
- 掌握「组合函数规范」的核心机制、典型用法与常见陷阱
- 掌握「基础 Composables」的核心机制、典型用法与常见陷阱
