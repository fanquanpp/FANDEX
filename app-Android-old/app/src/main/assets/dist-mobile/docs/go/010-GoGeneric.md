...
- [defer、panic 与 recover 详解](/go/009-DeferPanicRecoverDeepDive)：建议先完成前一篇的学习

## 学习目标

- 掌握「1. 泛型概述」的核心机制、典型用法与常见陷阱
- 掌握「2. 类型参数」的核心机制、典型用法与常见陷阱
- 掌握「3. 约束（Constraint）」的核心机制、典型用法与常见陷阱
- 掌握「4. 泛型函数」的核心机制、典型用法与常见陷阱
- 掌握「5. 泛型类型」的核心机制、典型用法与常见陷阱
