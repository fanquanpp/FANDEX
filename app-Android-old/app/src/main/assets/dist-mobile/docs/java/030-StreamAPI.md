...
- [Lambda 与函数式编程](/java/029-LambdaFunctionalProgramming)：建议先完成前一篇的学习

## 学习目标

- 掌握「0. 本节阅读指引（先读这一节）」的核心机制、典型用法与常见陷阱
- 掌握「1. Stream API 概述」的核心机制、典型用法与常见陷阱
- 掌握「2. 中间操作」的核心机制、典型用法与常见陷阱
- 掌握「3. 终端操作」的核心机制、典型用法与常见陷阱
- 掌握「4. 并行流」的核心机制、典型用法与常见陷阱
