...
- [Java 理论知识点： JVM 原理、类加载机制与内存管理](/java/066-JavaTheoryJVMClassLoadingMemory)：建议先完成前一篇的学习
...
- 掌握「3. 理论推导：操作系统层面的 I/O 模型」的核心机制、典型用法与常见陷阱
- 掌握「4. 代码示例（可运行 Java 代码）」的核心机制、典型用法与常见陷阱
