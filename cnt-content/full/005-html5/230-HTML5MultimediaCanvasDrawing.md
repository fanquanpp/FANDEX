...
- Canvas 进阶：`javascript/150-HigherOrderFunction` 理解回调与动画循环的配合；
- WebGL 与 3D：`css/530-CSSCanvasDrawing` 与 Three.js 官方示例；
- 音视频进阶：Web Audio 节点图、MediaSource 流式播放；
- 性能：`html5/380-CriticalRenderingPathAndResourceLoading` 中媒体资源加载策略；
