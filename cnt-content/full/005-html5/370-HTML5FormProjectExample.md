...
> 下一步学习出路：项目已经用上了 HTML5 的表单验证、存储、事件与拖拽，接下来三选一继续深入——CSS 进阶（`css/370-ResponsiveDesign` 与 `css/680-CSSProjectExampleResponsiveHomepage`）、JavaScript 进阶（`javascript/690-JavaScriptProjectPractice`）、或框架入门（`vue3/010-OverviewEnv`、`react/010-OverviewEnvSetup`）。记住：项目能力来自写出的代码量，继续做第二个、第三个项目比反复读文档更有效。
