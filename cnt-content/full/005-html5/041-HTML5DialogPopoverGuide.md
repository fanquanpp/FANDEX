...
这两个组件是"结构层就能实现的交互"。下一篇专项 `042-HTML5InternationalizationTags` 转向国际化：ruby、bdi、bdo 与多语言排版；2023-2025 的其他新元素与新能力（`<search>`、可定制 select、`hidden="until-found"` 等）见 `044-HTMLNewElementsAndCapabilities`。
