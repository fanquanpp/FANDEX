...
- [React Compiler 自动记忆化](/react/390-ReactCompilerAutoMemoization)：建议先完成前一篇的学习
...
5. **2025+：Server Actions 与全栈 React**
   ...
   - React 19 的 `useOptimistic`、`useFormStatus`、`useActionState`（由 `useFormState` 更名而来）进一步简化全栈交互。
