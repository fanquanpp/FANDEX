...
| **Copilot coding agent（编码智能体）** | 在 GitHub 上把 Issue 指派给 Copilot，它在云端自主开分支、写代码、提交 PR | 把需求单交给外包团队，验收时看 PR |
...
| 计划 | 价格 | 关键权益 | 适合谁 |
| :--- | :--- | :--- | :--- |
| **Copilot Free** | 免费 | 每月约 2000 次补全 + 少量 Chat/AI 额度 | 新手尝鲜 |
| **Copilot Pro** | 10 美元/月 | 无限补全 + Chat + 模型选择 | 个人开发者主力 |
| **Copilot Pro+** | 39 美元/月 | 更多 AI 额度、高级模型优先 | AI 重度用户 |

官方说明：通过 GitHub Education 认证的**学生与教师可免费使用 Copilot Pro**；**活跃的开源项目维护者**也可免费获得 Pro。也就是说没有名为"Student"的独立计划——认证走 GitHub Education，权益挂在 Pro 上。
