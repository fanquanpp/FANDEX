...
- [Go 与限流](/go/500-GoRateLimiting)：建议先完成前一篇的学习
...
| Go 1.19 | 2022-08 | `GOMEMLIMIT`/`debug.SetMemoryLimit`,内存上限与 GC 协同 |
| Go 1.20 | 2023-02 | channel 锁粒度优化,减少高并发竞争 |
| Go 1.21 | 2023-08 | `log/slog`、`context.WithoutCancel`、`sync.OnceFunc/OnceValue/OnceValues` |
| Go 1.22 | 2024-02 | 循环变量语义变更,消除 goroutine 捕获循环变量的经典陷阱 |
