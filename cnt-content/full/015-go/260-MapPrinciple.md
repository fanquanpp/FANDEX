...
- [切片原理](/go/250-SlicePrinciple)：建议先完成前一篇的学习
...
Go 1.24 由 Go 团队成员 Michael Pratt 主导完成 map 运行时的 **重大重构**，采用 Google 开源的 Swiss Table 算法（首次用于 Abseil `flat_hash_map`）。主要变化：
...
[3] Michael Pratt. 2024. Faster Go maps with Swiss Tables. (February 2024). Retrieved July 20, 2026 from https://go.dev/blog/swisstable. DOI: 10.25385/golang/blog/swisstable-1.24.
