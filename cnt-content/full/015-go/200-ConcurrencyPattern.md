...
- [GMP 调度模型](/go/170-GMPModel)：建议先完成前一篇的学习
...
| Go 1.21 | 2023-08 | `context.WithoutCancel`,衍生 context 不继承取消;`sync.OnceFunc`、`sync.OnceValue/OnceValues` |
| Go 1.22 | 2024-02 | 循环变量语义变更,消除 fan-out 闭包陷阱 |
