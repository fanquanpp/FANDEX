...
> 跨模块引用：跳跃表与红黑树、AVL 的对比详见 [平衡树与高级树](/algorithm$2。Redis 中跳跃表的应用详见 [Redis 有序集合](/redis$2。
...
- [平衡树与高级树](/algorithm$2 — 红黑树、AVL、B 树、Splay 树的对比
- [链表](/algorithm$2 — 跳跃表的底层结构基础
- [树](/algorithm$2 — 二叉搜索树、堆、Trie 的形式化定义
- [哈希表](/algorithm$2 — 无序集合的 $O(1)$ 替代方案
- [线段树](/algorithm$2 — 区间查询的另一种 $O(\log n)$ 方案
