...
- 背景体系：`css/290-BackgroundEnhancement`；
- 颜色与插值：`css/400-ModernColorSpace`（oklab/oklch）；
- 动画：`css/330-CSSAnimationTransition` 中渐变动画；
- 实战：`css/680-CSSProjectExampleResponsiveHomepage` 的渐变应用。
