...
- [程序结构与基本语法](/c/003-ProgramStructureBasicSyntax)：会写、会编译一个基础的 C 程序
...
更多属性与编译器扩展的对照见 [属性与编译器扩展](/c/020-AttributeCompilerExtension)。
...
- 下一版标准 C2y 仍处草案阶段（GCC 15 / Clang 20 提供早期开关），defer 等特性在正式发布前随时可能调整，详见 [C23 与 C2y 新标准](/c/040-C23C2y)。
