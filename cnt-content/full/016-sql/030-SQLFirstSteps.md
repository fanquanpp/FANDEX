...
related:
  ...
  - 'sql/120-DML'
  - 'sql/110-DDL'
  - 'sql/130-SQLProjectMusicLibrary'
prerequisites:
...
版本建议：选择 LTS 长期支持线（当前为 8.4 LTS 与 9.7 LTS）；历史上 9.0～9.4
属于 Innovation 创新线，尝鲜可以，学习与生产以 LTS 为准（8.0 已进入官方
支持尾声，新项目请直接选 8.4+）。
...
- 环境就绪、三张表就位，下一课 [数据查询基础](/sql/040-DataQueryBasics) 系统学习 SELECT；
  想检验综合能力时直接挑战 [SQL 综合实战：曲库数据库](/sql/130-SQLProjectMusicLibrary)。
