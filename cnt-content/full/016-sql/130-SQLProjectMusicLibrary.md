...
设计要点回顾（对应 [约束详解](/sql/100-Constraint)）：
...
- 延伸方向：查询性能如何保障？继续学习 [索引](/sql/420-Index) 与 [执行计划](/sql/430-ExecutionPlan)；
  想见识面试题风格的综合题库，见 [SQL 实战与面试](/sql/450-SQLPracticeInterview)。
