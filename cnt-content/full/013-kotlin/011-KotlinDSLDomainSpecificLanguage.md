...
- [Kotlin 多平台](/kotlin/010-KotlinMultiplatform)：建议先完成前一篇的学习

## 学习目标

- 掌握「1. DSL 概述」的核心机制、典型用法与常见陷阱
- 掌握「2. 带接收者的 Lambda」的核心机制、典型用法与常见陷阱
- 掌握「3. 类型安全构建器」的核心机制、典型用法与常见陷阱
- 掌握「4. 中缀函数」的核心机制、典型用法与常见陷阱
- 掌握「5. 运算符重载」的核心机制、典型用法与常见陷阱
