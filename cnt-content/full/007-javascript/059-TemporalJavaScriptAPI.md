...
- [JavaScript 最新特性与运行时](/javascript/058-JavaScriptLatestFeature)：建议先完成前一篇的学习

## 学习目标

- 掌握「0. 导言」的核心机制、典型用法与常见陷阱
- 掌握「1. 历史动机与技术演进」的核心机制、典型用法与常见陷阱
- 掌握「2. 形式化定义」的核心机制、典型用法与常见陷阱
- 掌握「3. Temporal 类型详解」的核心机制、典型用法与常见陷阱
- 掌握「4. 字符串格式与解析」的核心机制、典型用法与常见陷阱
