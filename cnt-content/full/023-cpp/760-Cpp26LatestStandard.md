...
- [C++ 概述与现代标准](/cpp/020-CppOverviewAndModernStandard)：了解 C++ 标准的三年一版节奏
- [C++23 新特性](/cpp/730-Cpp23NewFeatures)：C++26 的很多特性建立在 C++23 之上（如 mdspans 之于 linalg）
...
细节见 [内存序与无锁编程](/cpp/460-MemoryOrderLockFree) 的并发回收讨论。
