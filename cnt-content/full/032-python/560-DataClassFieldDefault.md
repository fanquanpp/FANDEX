...
- [描述符](/python/570-Descriptor)：建议先完成前一篇的学习
...
- 本项目 `python/530-TypeAnnotationMypy`：Python 类型注解的完整指南。
- 本项目 `python/540-TypingAdvanced`：泛型编程与类型变量。
- PEP 484《Type Hints》：https://peps.python.org/pep-0484/

### 11.2 描述符协议

- 本项目 `python/570-Descriptor`：描述符与 dataclass 的底层关联。
- 本项目 `python/580-PythonDescriptorProtocol`：`@property` 与描述符的关系。
...
1. 学习 Python 类与对象基础（`python/460-OOP`）。
2. 了解类型注解（`python/530-TypeAnnotationMypy`）。
