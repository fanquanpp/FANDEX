...
- [类型安全的发布订阅](/typescript/049-TypeSafePubSub)：建议先完成前一篇的学习

## 学习目标

- 掌握「引言：TypeScript 5.x 的时代意义」的核心机制、典型用法与常见陷阱
- 掌握「1. 历史背景与版本时间线」的核心机制、典型用法与常见陷阱
- 掌握「2. const 类型参数（const Type Parameters）」的核心机制、典型用法与常见陷阱
- 掌握「3. satisfies 操作符」的核心机制、典型用法与常见陷阱
- 掌握「4. ECMAScript Stage 3 装饰器」的核心机制、典型用法与常见陷阱
