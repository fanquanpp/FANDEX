...
- [类型安全的配置系统](/typescript/630-TypeSafeConfigSystem)：建议先完成前一篇的学习

## 学习目标

- 掌握「0. 引言：为什么数据库访问需要类型安全」的核心机制、典型用法与常见陷阱
- 掌握「1. 历史动机与技术演进」的核心机制、典型用法与常见陷阱
- 掌握「2. 形式化定义」的核心机制、典型用法与常见陷阱
- 掌握「3. 理论推导：Row 类型的推导原理」的核心机制、典型用法与常见陷阱
- 掌握「4. 实现类型安全的查询构建器」的核心机制、典型用法与常见陷阱
