...
- [Rust 环境搭建与工具链](/rust/030-RustEnvSetup)：Cargo 的基本命令与项目结构。
- [常用生态与实战](/rust/140-RustEcosystemProject)：serde、tokio 等依赖的使用背景。
...
resolver = "2" # feature 解析算法 v2（2021 edition 默认；2024 edition 默认为 v3）
