...
- [内存逃逸分析](/go/280-MemoryEscapeAnalysis)：建议先完成前一篇的学习
...
混合屏障结合了 Dijkstra 与 Yuasa 的优点,避免了栈重扫除,代价是屏障本身略贵。其设计与正确性论证见 Austin Clements 2016 年的设计文档 *Proposal: Eliminate STW stack re-scanning*（随 Go 1.8 落地）。
