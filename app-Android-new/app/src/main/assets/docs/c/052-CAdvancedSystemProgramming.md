...
- [C 语言理论知识点](/c/051-CLanguageTheory)：建议先完成前一篇的学习

## 学习目标

- 掌握「1. 高级数据结构」的核心机制、典型用法与常见陷阱
- 掌握「2. 内存管理」的核心机制、典型用法与常见陷阱
- 掌握「3. 系统编程」的核心机制、典型用法与常见陷阱
- 掌握「4. 网络编程」的核心机制、典型用法与常见陷阱
- 掌握「5. 高级特性」的核心机制、典型用法与常见陷阱
