...
- [类型注解与 mypy](/python/063-TypeAnnotationMypy)：建议先完成前一篇的学习

## 学习目标

- 掌握「1. 类与实例 (Class & Instance)」的核心机制、典型用法与常见陷阱
- 掌握「2. 属性与方法 (Properties & Methods)」的核心机制、典型用法与常见陷阱
- 掌握「3. 继承与多态 (Inheritance & Polymorphism)」的核心机制、典型用法与常见陷阱
- 掌握「4. 特殊方法 (Magic Methods)」的核心机制、典型用法与常见陷阱
- 掌握「5. 高级面向对象特性」的核心机制、典型用法与常见陷阱
