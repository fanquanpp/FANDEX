...
- [Python 与代码质量](/python/770-PythonCodeQuality)：建议先完成前一篇的学习

## 学习目标

- 掌握「1. Python 并发模型概述」的核心机制、典型用法与常见陷阱
- 掌握「2. 多线程」的核心机制、典型用法与常见陷阱
- 掌握「3. 线程池与进程池」的核心机制、典型用法与常见陷阱
- 掌握「4. asyncio 异步编程」的核心机制、典型用法与常见陷阱
...
async def mixed_code():
    loop = asyncio.get_running_loop()  # 协程内获取当前循环（不要用已弃用的 get_event_loop）
