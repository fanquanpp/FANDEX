...
- [变量与常量](/python/090-VariableConstant)：建议先完成前一篇的学习
...
- `python/590-Metaclass`: 元类与描述符的协作
- `python/500-Decorator`: 装饰器与描述符的等价关系（`property` 即装饰器即描述符）
- `python/460-OOP`: 新式类与 MRO
- `python/610-PythonDesignPattern`: 描述符实现的设计模式（观察者、代理、单例）
