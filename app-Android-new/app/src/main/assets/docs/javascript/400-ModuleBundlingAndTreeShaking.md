...
- [JavaScript 模块化](/javascript/380-JavaScriptModular)：理解 import/export 的语义是本文的前提。
...
- 模块：`javascript/380-JavaScriptModular`；
- 动态导入：`javascript/390-ModuleDynamicImportCodeSplitting`；
- 构建工具：`vite/010-ViteOverview`。
