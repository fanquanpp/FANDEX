...
- [JavaScript 原型与继承](/javascript/018-JavaScriptPrototypeInheritance)：建议先完成前一篇的学习

## 学习目标

- 掌握「1. 历史动机：为什么 JavaScript 选择原型继承」的核心机制、典型用法与常见陷阱
- 掌握「2. 形式化定义」的核心机制、典型用法与常见陷阱
- 掌握「3. 理论推导：属性查找的算法」的核心机制、典型用法与常见陷阱
- 掌握「4. 代码示例：从原型到 class 的完整演进」的核心机制、典型用法与常见陷阱
- 掌握「5. 对比分析：常见继承方案」的核心机制、典型用法与常见陷阱
