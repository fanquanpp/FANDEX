...
- [相等契约救急锦囊： equals 与 hashCode](/java/020-EqualsHashCodeContract)：建议先完成前一篇的学习

## 学习目标

- 掌握「0. 本节阅读指引（先读这一节）」的核心机制、典型用法与常见陷阱
- 掌握「1. 集合体系概览 (Hierarchy)」的核心机制、典型用法与常见陷阱
- 掌握「2. List 接口」的核心机制、典型用法与常见陷阱
- 掌握「3. Set 接口」的核心机制、典型用法与常见陷阱
- 掌握「4. Map 接口」的核心机制、典型用法与常见陷阱
