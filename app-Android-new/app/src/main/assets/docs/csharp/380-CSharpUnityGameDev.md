...
- [源生成器](/csharp/240-SourceGenerator)：建议先完成前一篇的学习
...
| Unity 6（6000.x，当前 LTS） | C# 9.0 | .NET Standard 2.1 | Mono/IL2CPP；CoreCLR 播放器实验性 |
| Unity 7（规划中） | C# 9.0（迁移初期） | CoreCLR（迁移中） | Mono 到 CoreCLR 迁移分阶段进行 |
