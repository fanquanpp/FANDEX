...
- [内联类](/kotlin/200-InlineClass)：建议先完成前一篇的学习
...
### 4.11 Context Parameter 扩展（实验性）

```kotlin
package com.example.contextext

// Kotlin 2.2 引入的上下文参数（Context Parameters，实验性）
// 取代并废弃了更早的 "context receiver" 实验设计
