...
- [Kotlin 类与对象](/kotlin/050-KotlinClassObject)：主构造函数、属性与 val/var 的基本语法。
- [Kotlin 基础语法](/kotlin/030-KotlinBasicSyntax)：变量、函数与判等的语言基础。
- [集合操作](/kotlin/110-KotlinCollectionOperation)：数据类最常见的去处是集合，理解容器判等有助于本篇实践。
